...
std::string vignette = "";
std::string gammaCalib = ""; //pcalib.txt文件
std::string source = "";//图像的zip包文件
std::string calib = ""; //标定文件
double rescale = 1;
bool reverse = false;
...
void parseArgument(char* arg)
{
	...
	if(1==sscanf(arg,"files=%s",buf))//走这里
	{
		source = buf;
	...
	if(1==sscanf(arg,"calib=%s",buf))//走这里
	{
		calib = buf;
	...
	if(1==sscanf(arg,"vignette=%s",buf))//走这里
	{
		vignette = buf;
	...
	if(1==sscanf(arg,"gamma=%s",buf))//走这里
	{
		gammaCalib = buf;
...
//bin/dso_dataset 
//files=/home/lb/smb/sequence_02/images.zip
//calib=/home/lb/smb/sequence_02/camera.txt 
//gamma=/home/lb/smb/sequence_02/pcalib.txt 
//vignette=/home/lb/smb/sequence_02/vignette.png
//preset=0 
//mode=0
